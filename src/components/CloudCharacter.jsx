...
const PuffyCloud = ({ mood = 'IDLE' }) => {
  ...
  return (
    <div className="relative w-[90px] h-[90px] flex items-center justify-center -mt-8 pb-4">
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center pb-2">
          <div className="flex lg:gap-2  gap-4 items-center translate-y-1">
            {/* Left Eye */}
            <div className="relative w-2 h-6 sm:w-5 sm:h-6">
              <motion.div
