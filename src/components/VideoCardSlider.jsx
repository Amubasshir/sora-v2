...
export default function VideoSlider() {
  ...
  // 👇 controls "animate only once on screen"
  ...
  // Run animation only once when visible
  useEffect(() => {
  ...
  return (
    <section
      ref={sliderRef}
      className="relative mx-auto w-full pb-[140px] md:pb-[130px]"
    >
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center pb-[15px] md:mt-[160px]">
        {/* LEFT TEXT */}
        <div className="px-5">
        ...
        <div className="relative flex justify-center flex-col items-center gap-5 px-4">
          ...
          <div className="absolute left-10 md:-left-20 bottom-10 md:bottom-20 inline-block z-20">
            <motion.div
              ...
              className="bgnav p-2 sm:p-3 px-4 sm:px-6 rounded-full flex gap-3 max-w-90 w-full text-sm md:text-base font-medium items-center"
            >
              <TextType
                key={index}
                text={[videos[index].title]}
